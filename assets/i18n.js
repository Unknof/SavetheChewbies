(function () {
  ...
  const translations = {
    ...
    zh: {
      ...
      'index.meta.title': '拯救秋伊小跟班',
      'index.meta.description': '通过 Tiltify 为拯救孩子捐款，并实时查看捐款里程碑与激励。',
      'index.brandTagline': '为拯救孩子捐款',
      'index.hero.title': '让你的捐款更有意义。',
      'index.hero.leadHtml':
        '这里是一个简单的捐款中心，帮助你通过 <strong>Tiltify</strong> 为 <strong>拯救孩子</strong> 捐款。',
      'index.hero.donateNow': '立即捐款',
      'index.hero.seeMilestones': '查看里程碑',
      'index.howItWorks': '如何参与',
      'index.howItWorks.1Html': '点击 <strong>立即捐款</strong>。',
      'index.howItWorks.2Html': '在 Tiltify 上为 <strong>拯救孩子</strong> 捐款。',
      ...
      'index.card.saveTheChildren': '拯救孩子',
      'index.card.saveTheChildren.body': '历史悠久、信誉良好的公益组织。本次活动仅支持拯救孩子。',
      'index.card.saveTheChildren.link': '通过 Tiltify 捐款 →',
      'index.card.milestones': '里程碑与激励',
      'index.card.milestones.body': '跟踪捐款里程碑，解锁游戏内小秋伊的特殊功能与外观内容。',
      'index.card.milestones.link': '查看里程碑 →',
      'index.card.incentives': '激励内容',
      'index.card.incentives.body':
        '我们正在制作 5 个与游戏内宠物小秋伊相关的捐款激励。它们会显示在 Tiltify 上，并同步到本站。',
      'index.card.incentives.link': '查看里程碑 →',
      'index.card.incentives.note':
        '我也会直播这些内容的实现过程（Discord，条件允许的话也会在 bilibili）。直播时间会发布在这里。',
      'index.card.why351': '为什么是 €351？',
      'index.card.why351.body':
        '激励金额来自 1 月 10–11 日的一场凯瑞甘生存（KS）锦标赛：玩家一共召唤出了 351 只秋伊小跟班。',
      ...
      'donate.meta.title': '捐款 • 拯救秋伊小跟班',
      'donate.meta.description': '通过 Tiltify 为拯救孩子捐款，并支持小秋伊筹款活动。',
      'donate.brandTagline': '捐款',
      'donate.title': '捐款',
      'donate.lead': '为拯救孩子出一份力，并解锁游戏内奖励！',
      'donate.section.title': '为拯救孩子捐款',
      'donate.section.body': '捐款将通过 Tiltify 的安全平台直接完成。你的支持会帮助拯救孩子，并解锁下方里程碑。',
      'donate.section.cta': '前往 Tiltify 捐款',
      'donate.section.note': '本站不处理支付信息。捐款由 Tiltify 安全处理。',
      'donate.incentives.title': '激励（里程碑）',
      'donate.incentives.body':
        '为了给捐赠者更多动力，我们正在制作 5 个与游戏内宠物小秋伊相关的激励内容。一旦 Tiltify 上的激励列表确定，将同步到这里。',
      ...
      'donate.incentives.note3':
        '为什么是 €351？它来自 1 月 10–11 日的一场凯瑞甘生存（KS）锦标赛：玩家一共召唤出了 351 只秋伊小跟班。',
      'donate.incentives.creatorPledge':
        '发起人承诺（概念验证）：我会为锦标赛中每一次使用小秋伊额外捐出 €10（共 6 次 → €60），先把活动带起来。',
      ...
      'donate.m1.desc': '当小秋伊被击退时，秋伊小跟班会闹点小脾气（无害 / 纯外观）。',
      'donate.m1.liHtml':
        '<strong>€351 — 闹脾气（被击退反应）：</strong>当小秋伊被击退时，秋伊小跟班会闹点小脾气（无害 / 纯外观）。',
      'donate.m2.name': '玩闹对练',
      ...
      'donate.m3.desc': '小秋伊偶尔会建造冰洞，并带有有趣的建造动画。',
      'donate.m3.liHtml': '<strong>€702 — 冰洞（建造过程）：</strong>小秋伊偶尔会建造冰洞，并带有有趣的建造动画。',
      'donate.m4.name': '虫洞传送（更“时髦”的方式）',
      'donate.m4.desc': '小秋伊与秋伊小跟班会使用虫洞传送到当前英雄身边。',
      'donate.m4.liHtml':
        '<strong>€1053 — 虫洞传送（更“时髦”的方式）：</strong>小秋伊与秋伊小跟班会使用虫洞传送到当前英雄身边。',
      'donate.m5.name': '机甲小秋伊（皮肤）',
      'donate.m5.desc': '为小秋伊添加机甲皮肤（类似机甲秋伊，但目前小秋伊还没有）。',
      'donate.m5.liHtml':
        '<strong>€1404 — 机甲小秋伊（皮肤）：</strong>为小秋伊添加机甲皮肤（类似机甲秋伊，但目前小秋伊还没有）。',

      'privacy.meta.title': '隐私与联系 • 拯救秋伊小跟班',
      'privacy.meta.description': '拯救秋伊小跟班的隐私说明与联系方式。',
      ...
      'gallery.meta.title': '图集 • 拯救秋伊小跟班',
      'gallery.meta.description': '小秋伊互动与游戏内容的社区图集。',
      'gallery.brandTagline': '图集',
      'gallery.title': '图集',
      'gallery.lead': '社区截图与 GIF，展示小秋伊与秋伊小跟班的精彩瞬间。',
      'gallery.submit.title': '投稿你的截图',
      'gallery.submit.body': '喜欢小秋伊？有精彩的截图或 GIF 想分享？发给我们，我们会添加到图集中！',
      'gallery.submit.emailHtml':
      ...
      'gallery.submit.note': '我们会审核投稿并挑选最精彩的内容，展示小秋伊的有趣互动与瞬间！',
      ...
      'story.h2.1': '秋伊是什么？',
      'story.p.1':
        '秋伊（Chew）和他的秋伊小跟班（chewbies）来自《星际争霸 II》街机模式的一张地图，由一群热爱游戏的玩家共同开发。这张地图叫凯瑞甘生存（KS），大约在 201X 年左右上线（待确认）。从那以后，来自世界各地的人投入了无数时间不断改进它，慢慢把它打磨成今天的样子。',
      'story.p.2':
        '《星际争霸 II》是暴雪娱乐出品的即时战略游戏，以高水平的多人对战与剧情战役而闻名。',
      'story.h2.2': '起点',
      'story.p.3':
        '秋伊的故事起源于一个很傻的想法——甚至算不上概念。受凯瑞甘生存长期版主 Chewbacca 的启发，秋伊最初只是一个很简单的游戏内宠物：来自《星际争霸 II》宇宙中一颗遥远寒冷星球的“雪地族母”。一开始，秋伊是对 Chewbacca 长期支持与付出的真挚回馈，也只允许他一人使用。',
      'story.p.4':
      ...
      'story.p.9Html': '<em>“让我更像我一点，先把小秋伊做出来吧。”</em>',
      'story.h2.4': '“重做”',
      'story.p.10':
        '很长一段时间，很多人（包括开发者）都觉得凯瑞甘生存是个在逐渐衰落的 RTS 品类里慢慢走向死亡的街机地图。但事实证明，CN 服务器的玩家基数其实比 EU 和 NA 加起来还大。这个发现让我充满动力，想做出一个我自己都觉得很棒的东西。',
      'story.p.11': '于是我做了小秋伊。',
      'story.p.12':
        '而且不——我不是做了一个像原版宠物那样跟着你的小玩意。恰恰相反。小秋伊有大量小互动、隐藏彩蛋，以及对一些早已被遗忘的能力的玩笑（RIP 假死）。小秋伊可以被 10 位玩家同时使用，在对局里制造恰到好处的额外混乱。',
      'story.p.13':
        '最开始，小秋伊只能通过一个特殊聊天指令召唤。后来在锦标赛之后不久，我加了一个正式按钮。小秋伊的效果出奇地好，让我觉得它完全有潜力变成更大的东西。',
      'story.h2.5': '锦标赛',
      'story.p.14':
        '纯属巧合的是，在我回归 KS 不久后，我听说 CN 服务器在 1 月 10 / 11 日要举办一场大型锦标赛。我赶紧花了一两个小时把小秋伊打磨了一下，确保能在活动期间把它公布出来。',
      'story.p.15': '为了进一步激励玩家，我提出为公益组织（拯救孩子）捐款：',
      'story.p.16Html': '<strong>每召唤一次小秋伊，我捐 $1。</strong>',
      'story.p.17':
        '不过，由于比赛是高水平的竞技对抗——而小秋伊其实在某种程度上会成为劣势（它更容易暴露你的英雄位置）——所以镜头并不多。最终只召唤了 6 次小秋伊（最多可能 100 次）。',
      'story.p.18': '所以我改成了每次小秋伊自掏腰包捐 $10。',
      'story.h2.6': '那秋伊小跟班呢？',
      'story.p.19':
        '这 6 次小秋伊在仅仅两局里累计产出了 351 只秋伊小跟班。既然我自己显然也越来越像秋伊了，我就想：',
      'story.p.20Html': '<em>“总得有人照顾这些秋伊小跟班。”</em>',
      'story.p.21': '于是我就做了你现在正在看的这个网站。',
      'story.p.22': '为了进一步推动大家为善事捐款，我也承诺会继续为所有玩家改进小秋伊！',
      'story.p.23':
        '（是的，目前仅限 CN 服务器，因为小秋伊暂时无法加入 EU/NA。这不是我们的问题——是暴雪的问题——不过他们承诺 Soon™ 会修好）',
      'story.p.24': '当你捐款帮助世界各地的孩子时，你也在帮助小秋伊变得更好。',
      'story.p.25Html': '相信我：<strong>他现在已经强得离谱了。</strong>',
      'story.h2.7': '备注',
      'story.p.26': '小秋伊不会替代原版秋伊（Chew）。',
      'story.p.27': '秋伊会在 2026 年 1 月底前回归凯瑞甘生存（KS）（目前仅限 CN 服务器）。',
      'story.p.28': '爱你们——也请一起拯救秋伊小跟班 ❤️',
      'story.p.29': 'Sox',
      'story.ackLink': '致谢 →',

      'ack.meta.title': '致谢 • 拯救秋伊小跟班',
      'ack.meta.description': '拯救秋伊小跟班致谢。',
      'ack.brandTagline': '致谢',
      'ack.title': '致谢',
      'ack.lead': '衷心感谢那些直接或间接帮助本项目的人。',
      'ack.ks.title': '凯瑞甘生存（KS）',
      ...
      'charities.meta.title': '公益组织 • 拯救秋伊小跟班',
      'charities.meta.description': '本项目支持拯救孩子。',
      'charities.title': '公益组织',
      'charities.leadHtml': '本项目目前仅支持一个公益组织：<strong>拯救孩子</strong>。',
      'charities.card.title': '拯救孩子',
      'charities.card.body':
      ...
      'verify.meta.title': '验证捐款 • 拯救秋伊小跟班',
